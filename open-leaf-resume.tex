...
\begin{document}
    ...
    \normalsize
    Master’s in CS @ USC | 2 YOE at JPMorgan | Published ML Research | PyTorch, AWS, Full-Stack | Applied AI \& Research Enthusiast
...
\end{header}
    ...
    \section{Education}
        \begin{twocolentry}{
            ...
            \textbf{University of Southern California}, Los Angeles, CA, Masters in Computer Science\end{twocolentry}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Migrated 4 key Android components from Java to Kotlin, improving readability \& maintainability across 80+ files.
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Treasure (Startup)}\end{twocolentry}
        ...
        \vspace{0.10 cm}
        \begin{onecolentry}
            \textit{Guide:} Ravi Kiran\hfill \textit{Role:} Research Intern, CVIT, IIIT Hyderabad\\
            \begin{highlights}
